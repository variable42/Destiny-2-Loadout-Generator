...
val classArmor = df.filter($"Equippable" === characterClass)
    ...
    // .withColumn("Mobility", when(($"Perks 0" === "Mobility Mod*" || $"Perks 2" === "Mobility Mod*" || $"Perks 3" === "Mobility Mod*") && ($"Type" !== classItemName), ($"Mobility" - 10)).otherwise($"Mobility"))
    // .withColumn("Resilience", when(($"Perks 0" === "Resilience Mod*" || $"Perks 2" === "Resilience Mod*" || $"Perks 3" === "Resilience Mod*") && ($"Type" !== classItemName), ($"Resilience" - 10)).otherwise($"Resilience"))
    // .withColumn("Recovery", when(($"Perks 0" === "Recovery Mod*" || $"Perks 2" === "Recovery Mod*" || $"Perks 3" === "Recovery Mod*") && ($"Type" !== classItemName), ($"Recovery" - 10)).otherwise($"Recovery"))
    // .withColumn("Discipline", when(($"Perks 0" === "Discipline Mod*" || $"Perks 2" === "Discipline Mod*" || $"Perks 3" === "Discipline Mod*") && ($"Type" !== classItemName), ($"Discipline" - 10)).otherwise($"Discipline"))
    // .withColumn("Intellect", when(($"Perks 0" === "Intellect Mod*" || $"Perks 2" === "Intellect Mod*" || $"Perks 3" === "Intellect Mod*") && ($"Type" !== classItemName), ($"Intellect" - 10)).otherwise($"Intellect"))
    // .withColumn("Strength", when(($"Perks 0" === "Strength Mod*" || $"Perks 2" === "Strength Mod*" || $"Perks 3" === "Strength Mod*") && ($"Type" !== classItemName), ($"Strength" - 10)).otherwise($"Strength"))
...
val helmets = classArmor.filter($"Type" === "Helmet")
    ...
    .drop("Perks 0","Perks 1","Perks 2","Perks 3")
...
val joined = helmets
    ...
    //   .withColumn("Combo_MW", floor($"Recovery_MW" / 10) + floor($"Discipline_MW" / 10))
